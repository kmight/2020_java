...
public class Ex08 {
	public static void main(String[] args) {
		...
		System.out.println(ch2[0][0]);
		System.out.println(ch2[0][1]);
		System.out.println(ch2[1]);
		System.out.println(ch2[1][0]);
		System.out.println(ch2[1][1]);
		System.out.println(ch2[2]);
		System.out.println(ch2[2][0]);
		System.out.println(ch2[2][1]);
		*/
	}
}

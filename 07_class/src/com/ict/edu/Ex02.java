...
public class Ex02 {
	...
	public static void main(String[] args) {
		...
		// 보통 입출력할 때 사용한다. (대소문자, 숫자만 가능, 영어이외의 글자는 안됨)
		String str8 = "java";
		...
		//	char 나 String이 들어오면 해당ㅁ누자열에 char나 String의 위치값을 알려준다
		//	찾는 문자나 문자열이 없으면 -1
		...
		k1 = str10.indexOf('K'); // char는 ''
		System.out.println(k1);
		
		k1 = str10.indexOf("fer"); // 문자열은 ""
		System.out.println(k1);		
		System.out.println("-----------------");
		...
		// 10. replace(char oldChar, char newChar), replace(CharSequence target, CharSequence replacement) : String

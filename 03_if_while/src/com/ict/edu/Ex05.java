...
public class Ex05 {
	public static void main(String[] args) {
		...
		// a ~ g
		for (char i = 'a'; i <= 'g'; i++) {
			// 옆으로 출력하기, /t는 tab(일정 간격 띄우기)을 의미
			System.out.print(i + "\t");
		} // for
		System.out.print("가나\n다라");
		// 한 줄 띄우기
		System.out.println(); // 줄바꿈 기능이 있어 인자가 비어도 된다.
		// 존재하지 않는 메소드
		// System.out.print(); // print() <- 인자를 반드시 넣어야 한다.
		...
		System.out.println("짝수 누적합 : " + even);
		...
		System.out.println("홀수 짝수 누적합 : " + (int)(odd + even));
